...
analyze -clear
analyze -sv12 -f ${AUTOSVA_ROOT}/ft_tlb/files.vc
# Elaborate design and properties
elaborate -top tlb -bbox_a 131072 -bbox_mul 128 -bbox_mod 64 -create_related_covers {witness precondition} -auto_hr_info
#-parameter SOURCES 4
